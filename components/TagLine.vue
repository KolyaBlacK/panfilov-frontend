<template>
  <div class="tag-line">
    ...
    <div class="third-line">
      ...
      <div class="right">
        <button class="show-reel" @click="showReel">Show reel</button>
      </div>
    </div>
    ...
    <div v-if="isShowReelContainer" ref="reelContainer" class="reel-container">
    ...
    showReel () {
      ...
      this.$nextTick(() => {
        ...
        this.strokeWidthTimeout = setTimeout(() => {
          path.style.strokeWidth = 10000;
          path.style.transition = path.style.WebkitTransition =
          'stroke-width 2s ease-in-out';
        }, 2000);
